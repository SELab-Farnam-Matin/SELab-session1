...
در این تمرین، برای مواردی مانند نوشتن کد برنامه و کشف خطاها از ابزارهای هوش مصنوعی استفاده کردیم. همچنین در مواردی مانند مستقر کردن (deploy) روی github pages از هوش مصنوعی برای تولید کد deploy.yml استفاده کردیم. در پاسخ به سوالات پایین صفحه نیز از هوش مصنوعی کمک گرفتیم.